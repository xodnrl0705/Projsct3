...
<div id="top" style="border:0px solid #000;"> 
	...
	<ul id="lnb">
		...
		<% }else{ %>
		<!-- 로그인후 -->
		<li><a href="../main/Logout.jsp"><img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../Community/List?bname=protector" target="" />
